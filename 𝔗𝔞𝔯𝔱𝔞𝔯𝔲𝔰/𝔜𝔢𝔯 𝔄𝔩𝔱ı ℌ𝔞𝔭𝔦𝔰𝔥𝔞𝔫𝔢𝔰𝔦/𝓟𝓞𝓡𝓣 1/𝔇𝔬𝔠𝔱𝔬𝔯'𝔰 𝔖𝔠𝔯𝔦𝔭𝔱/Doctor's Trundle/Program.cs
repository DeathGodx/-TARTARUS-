    ...
    internal class Program
    {
        ...
        private static void Combo()
        {
            ...
            if (target != null)
            {
                ...
                var pos = E.GetPrediction(target).CastPosition.Extend(_Player.Position, -100);
        ...
        public static void ResetAttack(object e, OrbwalkerActionArgs args)
        {
            ...
            if (target != null)
            {
                ...
                if (HasQ && Q.IsReady() && Orbwalker.ActiveMode.HasFlag(OrbwalkerMode.Harass) && _Player.ManaPercent >= Hmana)
                {
                    Q.Cast();
