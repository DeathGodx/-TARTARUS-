    ...
    internal class Program
    {
        ...
        static void OnLoadingComplete()
        {
           ...
           // Chat.Print("Doctor's Talon PORTED By DEATHGODX!", Color.Orange);
            ...
            Q.SetSkillshot(1, 2300, 80, false, false, SkillshotType.Cone);
        ...
        public static void KillSteal()
        {
            ...
            foreach (var target in GameObjects.EnemyHeroes.Where(hero => hero.IsValidTarget(W.Range) && !hero.HasBuff("JudicatorIntervention") && !hero.HasBuff("kindredrnodeathbuff") && !hero.HasBuff("Undying Rage") && !hero.IsDead && !hero.IsSlowed))
            {
                if (KsQ && Q.IsReady())
                {
                    if (target != null)
